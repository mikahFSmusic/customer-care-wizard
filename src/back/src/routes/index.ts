...
import { getAllDamagedDefects, updateDamagedDefect } from '../controllers/damaged_defect'
import { deleteDamagedDefect } from '../../../API'
...
router.post('/submit-damaged-defect', upload.array('file', 1), async (req: Request, res: Response, next): Promise<void> => {
  try {
